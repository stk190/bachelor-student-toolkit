from modules.profile.manager import calculate_overall_cgpa, calculate_semester_gpa, dashboard_statistics, delete_student, register_student, view_all_students, view_transcript
...
def academic_records_menu():
    while True:
        ...
        if choice == "1":
            ...
            dashboard_statistics(ADMIN_PASSKEY)
        elif choice == "7":
            break
